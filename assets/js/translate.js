const translations = {
  ...
  ua: {
    ...
    part3: "Наші переваги:",
    part4: "Величезна бібліотека: ",
    part5:
      "Ми постійно оновлюємо каталог новими розділами та популярними тайтлами.",
    part6: "Зручна читалка:",
    part7:
      "Наш плеєр адаптований для комфортного читання як з комп’ютера, так і зі смартфона.",
    part8: "Висока якість:",
    part9:
      "Ми дбаємо про те, щоб зображення були чіткими, а завантаження сторінок — блискавичним.",
    part10:
